...
Abonar la inscripción (50%) via mercado pago: http://mpago.la/YLAH
...
Abonar el total del retiro via mercado pago (se aceptan tarjetas de credito): http://mpago.la/PW0C
...
1. Introducción al método
	1. Utilizando la mente para guiar el Qi
	1. Las visualizaciones mentales
	1. Beneficios
1. Practica: Elevar y volcar
	1. Puntos de acupuntura
	1. Requerimientos básicos de postura
	1. Apertura y Cierre
	1. Primer bloque
	1. Segundo bloque
	1. Tercer bloque
1. Practica: la union de los tres centros
	1. Introduccion
	1. Descripcion del método
1. Zhineng Taiji Ball 1
1. Ejercicios fundamentales
	1. Sentadillas
	1. Chen Qi
	1. Estirar la columna
	1. Rotacion de caderas
	1. La Qi
	1. Qigong de la boca
1. Teoria de los métodos
...
- Retiro de práctica de Taijiquan estilo Yang. 60 horas de práctica a cargo del Maestro Dr. Yang Jwing-Ming.
- Seminario de Taiji en silla de ruedas en Atlanta, Georgia, USA, a cargo del Profesor Zibin Guo (201
2).
...
El primer nivel de Zhineng tiene los siguientes beneficios:
